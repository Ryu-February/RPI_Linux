...
**<<img width="381" height="415" alt="image" src="https://github.com/user-attachments/assets/ee90c3f0-9a9d-46b9-863b-9ee524b32f69" />
>** — `docs/i2c-detect.png` : `i2cdetect` 주소 표와 `i2cget` 의 `0xe0` 출력이 한 화면에
...
**<<img width="384" height="164" alt="image" src="https://github.com/user-attachments/assets/56932a7d-87a5-4430-9ebf-26494c74d4b0" />
>** — `docs/i2c-probe.png` : `dmesg` 의 probe 로그(두 인스턴스)와 `i2cdetect` 의 `UU UU` 가 한 화면에
...
**<<img width="689" height="137" alt="image" src="https://github.com/user-attachments/assets/7c524452-d34c-446b-bcae-83d6b91cfc15" />
>** — `docs/i2c-sensor-read.png` : 두 인스턴스의 채널 값과, 한쪽을 가렸을 때의 변화
...
**<<img width="724" height="790" alt="image" src="https://github.com/user-attachments/assets/794975f8-3303-47fd-9975-fad66952b092" />
>** — `iio_info` 출력, 또는 IIO 경로에서 값을 읽는 화면
...
[← 6. LED 서브시스템](06-led-subsystem.md) · [목차](../README.md) · [8. GPIO 인터럽트 →](08-gpio-interrupt.md) · [8. GPIO 인터럽트 →](08-gpio-interrupt.md)
